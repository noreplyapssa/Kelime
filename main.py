...
def help(update, context):
    update.message.reply_text('MEVCUT KOMUTLAR:\n' +
                              ...
                              ' özel bot yapımı =>  , @Yorgun_Birisi\n\n' +
                              ' Güncelleme ve Bilgilendirme => @MajesteBotlar\n\n' +
                              ' music botu => @MajesteMusicRoBot\n\n' +
                              ' Tag botu @Majeste_TaggerBot', reply_to_message_id=True)
...
def cancel(update, context):
    ...
    if get_or_create_game(update.effective_chat.id):
        ...
        send_message(update, "❌ Oyun başarılı bir şekilde sonlandırıldı Özel reklam için => @Yorgun_Birisi .")
...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🧚 GRUPLARA EKLE!", url="https://t.me/MajesteKelimeOyunubot?startgroup=a")
        sohbet = InlineKeyboardButton(text="💬 tag botu ", url="https://t.me/Majeste_TaggerBot")
        oyun = InlineKeyboardButton(text="👾 Güncelleme ve Bilgilendirme", url="https://t.me/MajesteBotlar")
        admin = InlineKeyboardButton(text="👨🏻‍💻 Müzik botu", url="https://t.me/Majeste_MusicRoBot")

        keyboard = [[addme],[sohbet],[oyun],[admin]]
        reply_markup = InlineKeyboardMarkup(keyboard)
        update.message.reply_text('ÖZEL SOHBETTE OYUN OYNANMIYOR!\n'+
                                  'Merhaba! Botumuz @MajesteKelimeOyunubot oyunun telegrama uyarlanmış hali.Gruba ekleyip yetki verdikten sonra geriye oynamak kalıyor 😉 destek için @Yorgun_Birisi.Komutlar için /help yazınız!\n' +
